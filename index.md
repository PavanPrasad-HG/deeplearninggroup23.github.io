...
- Marnix worked on researching and implementation of the triplet loss, data extraction and implemtation of the final model. He worked on the evaluation of the model post connection of all individual parameters.
